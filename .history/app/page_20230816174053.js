      ...
      <main>
        ...
        <section id="clients" className="clients">
          <div className="container" data-aos="fade-up">
            <div className="row align-items-xl-center gy-4">
              <div className="col-xl-3 col-md-3 col-12 client-logo">
                <img
              ...
              <div className="col-xl-8 col-md-8 col-12 client-text">
                <h2>F Gas Register Certified Engineers</h2>
                <p>
                  Being an F Gas Register Certified Engineer signifies
                  top-tier proficiency in refrigeration, air conditioning,
                  and heat pump systems. This credential reflects safety
            ...
            <div className="row align-items-xl-center gy-5">
              <div className="col-xl-5 content">
                ...
                <p>
                  ...
                  dedication to tailored solutions, a trait that sets us
                  apart. Our specialization in internal water cooled air
                  conditioning remains unparalleled, and our bespoke
                  installation service, shaped by years of practice, is
                  offered at a price that reflects both our competitive
                  spirit and our uncompromising quality.
                </p>
              </div>
                ...
                <div className="row gy-4 icon-boxes">
                  ...
                  >
                    <div className="icon-box">
                      ...
                      <p>
                        Utilise our free on-site survey for tailored
                        planning and accurate solutions.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section id="services" className="services">
          <div className="container section-title" data-aos="fade-up">
            <h2>Services</h2>
            <p>
              Explore a selection of our provided services that exemplify
              our expertise.
            </p>
          </div>
              ...
              >
                <div className="service-item d-flex">
                  ...
                  <div>
                    ...
                    <p className="description pr-2">
                      Regular check-ups and cleaning of air conditioning
                      units to ensure optimal performance and energy
                      efficiency
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="service-item d-flex">
                  ...
                  <div>
                    ...
                    <p className="description pr-2">
                      Providing 24/7 assistance for urgent heating or
              ...
              >
                <div className="service-item d-flex">
                  ...
                  <div>
                    ...
                    <p className="description pr-2">
                      Changing or cleaning air filters to maintain indoor
