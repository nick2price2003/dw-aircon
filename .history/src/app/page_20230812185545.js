      ...
      <div className="container">
        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-6 " data-aos="fade-up" data-aos-delay="500">
            <div className="service-item d-flex">
              <div className="icon flex-shrink-0"><i class="bi bi-brightness-high"></i></div>
              <div>
                <h4 className="title"><a href="services-details.html" class="stretched-link">Nemo Enim</a></h4>
